...
class PaymentResourceIT {
    ...
    private static final Iva DEFAULT_IVA = Iva.YES;
    private static final Iva UPDATED_IVA = Iva.NO;

    private static final String DEFAULT_TOTAL = "AAAAAAAAAA";
    private static final String UPDATED_TOTAL = "BBBBBBBBBB";

    private static final PaymentMethod DEFAULT_PAYMENT = PaymentMethod.CREDIT;
    private static final PaymentMethod UPDATED_PAYMENT = PaymentMethod.CASHPAY;
    ...
    public static Payment createEntity(EntityManager em) {
        Payment payment = new Payment().date(DEFAULT_DATE).iva(DEFAULT_IVA).total(DEFAULT_TOTAL).payment(DEFAULT_PAYMENT);
        return payment;
    }
    ...
    public static Payment createUpdatedEntity(EntityManager em) {
        Payment payment = new Payment().date(UPDATED_DATE).iva(UPDATED_IVA).total(UPDATED_TOTAL).payment(UPDATED_PAYMENT);
        return payment;
    }
    ...
    void createPayment() throws Exception {
        ...
        assertThat(testPayment.getIva()).isEqualTo(DEFAULT_IVA);
    ...
    void putNewPayment() throws Exception {
        ...
        updatedPayment.date(UPDATED_DATE).iva(UPDATED_IVA).total(UPDATED_TOTAL).payment(UPDATED_PAYMENT);
        ...
        assertThat(testPayment.getIva()).isEqualTo(UPDATED_IVA);
    ...
    void partialUpdatePaymentWithPatch() throws Exception {
        ...
        partialUpdatedPayment.iva(UPDATED_IVA);
    ...
    void fullUpdatePaymentWithPatch() throws Exception {
        ...
        partialUpdatedPayment.date(UPDATED_DATE).iva(UPDATED_IVA).total(UPDATED_TOTAL).payment(UPDATED_PAYMENT);
